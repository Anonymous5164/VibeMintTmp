-- CreateEnum
CREATE TYPE "Chain" AS ENUM ('BASE', 'ARBITRUM');
...
-- AddForeignKey
ALTER TABLE "NFT" ADD CONSTRAINT "NFT_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;
